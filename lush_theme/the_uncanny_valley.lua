...
--    SpecialKey                                 { fg="#d7c483", },
    ...
    Special                                    { Constant },
    sym"@parameter"                            { fg = hsl(290,40,50) },
    sym"@lsp.type.parameter"                   { sym"@parameter" },
    Identifier                                 { fg = hsl(265,100,65) },
